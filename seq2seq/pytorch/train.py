...
def parse_args():
    ...
    distributed.add_argument('--ps', action='store_true', default=False,
                             help='whether use parameter server')
    ...
    profile.add_argument('--profile-start', default=10, type=int,
                         help="the step to start collecting traces")
    profile.add_argument('--profile-stop', default=50, type=int,                                                                                 help="the step to stop collecting traces")
    profile.add_argument('--cupti', action='store_true',
                         help="whether dumping cupti traces")
    profile.add_argument('--nsight', action='store_true',
                         help="whether dumping nsight-compute traces")
